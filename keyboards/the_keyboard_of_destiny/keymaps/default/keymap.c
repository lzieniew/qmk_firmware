...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ortho_4x10(
       ...
       KC_NO,   KC_NO,   KC_LGUI, _______, KC_SPC,     KC_ENT,   BACKSPACE_L3, KC_LGUI, KC_NO, KC_NO
    ),
    [2] = LAYOUT_ortho_4x10(
       ...
       KC_NO, KC_NO, KC_LGUI,   ESC_L3,  KC_SPC,     KC_ENT, _______, KC_RALT, KC_NO, KC_NO
    ),
    [3] = LAYOUT_ortho_4x10(
    ...
    [4] = LAYOUT_ortho_4x10(
        ...
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
        KC_NO,   KC_NO,  KC_NO, TO(0), KC_SPC, KC_ENT, BACKSPACE_L2, KC_BSPC, KC_NO, KC_NO
    )
};
